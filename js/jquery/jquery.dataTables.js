...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		 ...
		 *    'display index' if you have hidden data schools
		 *  @dtopt API
		 *
		 *  @example
		 *    $(document).ready(function() {
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the schools in the length drop
		 ...
		 * (i.e. "Showing 1 to 10 of 57 schools") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Showing _START_ to _END_ of _TOTAL_ schools
			 *  @dtopt Language
			 * 
			 *  @example
			 *    $(document).ready( function() {
			 *      $('#example').dataTable( {
			 *        "oLanguage": {
			 *          "sInfo": "Got a total of _TOTAL_ schools to show (_START_ to _END_)"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 of 0 schools
			 *  @dtopt Language
			 * 
			 *  @example
			 *    $(document).ready( function() {
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Showing 0 to 0 of 0 schools",
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total schools)
			 *  @dtopt Language
			 * 
			 *  @example
			 *    $(document).ready( function() {
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ total schools)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Show _MENU_ schools",
